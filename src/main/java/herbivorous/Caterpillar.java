...
public class Caterpillar extends Herbivorous {
    private static final double WEIGHT_PER_ELEMENT = 0.01;
    private static final int MAX_VALUE_OF_ORGANISMS_ON_CELL = 1000;
    private static final int AVAILABLE_CELLS_BY_MOVE = 0;
    private static final double KG_OF_CMPLT_SATURATION = 0;


    public Caterpillar(int height, int width) {
        super(height, width);
    }
