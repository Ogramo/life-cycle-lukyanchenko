...
public class Sheep extends Herbivorous {
    private static final int MAX_VALUE_OF_ORGANISMS_ON_CELL = 140;
    private static final double WEIGHT_PER_ELEMENT = 70;
    private static final int AVAILABLE_CELLS_BY_MOVE = 3;
    private static final double KG_OF_CMPLT_SATURATION = 15;

    public Sheep(int height, int width) {
        super(height, width);
    }
