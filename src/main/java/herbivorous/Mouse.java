...
public class Mouse extends Herbivorous {
    private static final int MAX_VALUE_OF_ORGANISMS_ON_CELL = 500;
    private static final double WEIGHT_PER_ELEMENT = 0.05;
    private static final int AVAILABLE_CELLS_BY_MOVE = 1;
    private static final double KG_OF_CMPLT_SATURATION = 0.01;
